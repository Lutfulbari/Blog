    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('bolg_title', models.CharField(max_length=100, verbose_name='Put a Title')),
                ('slug', models.SlugField(max_length=100, unique=True)),
                ('blog_content', models.TextField(verbose_name='What is on your mind?')),
                ('bolg_image', models.ImageField(upload_to='blog_images', verbose_name='Image')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('bolg', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='blog_comment', to='App_Blog.blog')),
